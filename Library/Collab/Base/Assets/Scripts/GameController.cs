...
public class GameController : MonoBehaviour
{
    ...
    void InitializeContractorList() {
        ...
        contractorController.names = new List<string>(new string[] { "Carl", "Joseph", "Joe", "Daniel", "Jude", "Betty", "Yangos", "Peter", "Sophie", "Mikayla", "Sam", "Dafne", "Jason", "Larry", "Richard", "Dave", "Patrick", "Jon", "Rachel", "Laura" });
